...
class Test(TestCase):
    ...
    # se rulaza inainte de fiecare test si are rolul de a face set-up-ul de chrome inainte de fiecare test
    def setUp(self):
    ...
    # TEST 1 # Primul test este pt a verifica url-ul
    ...
    def test_register_new_user(self):
        ...
        actual = self.chrome.find_element(*self.Submit_success_message).text
